...
#include "../config.h"
    ...
    #define p610_ZERO_WORDS 1              // Number of "0" digits in the least significant part of p610 + 1     
#elif (TARGET == TARGET_x86) || (TARGET == TARGET_ARM)
    #define NWORDS_FIELD    20 
    #define p610_ZERO_WORDS 2
#endif
    

// Basic constants

#define NBITS_FIELD             621  
...
#define ALICE                   0
#define BOB                     1 
#define OALICE_BITS             278  
#define OBOB_BITS               277    
#define OBOB_EXPON              119 
...
#define MAX_INT_POINTS_ALICE    15      
#define MAX_INT_POINTS_BOB      20 
#define MAX_Alice               175
#define MAX_Bob                 119
#define MSG_BYTES               24
...
void fpsqrt610_mont(const felm_t a, felm_t sqrta);
...
void fp2sqrt610_mont(const f2elm_t a, f2elm_t sqrta);
